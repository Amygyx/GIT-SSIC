...
import numpy as np
import models.utils.pretrained_networks as pn
import models.utils.lpips_op as lpips
        ...
        if(lpips):
            ...
            if(pretrained):
                if(model_path is None):
                    #model_path = '/gdata1/gaoyx/clic2021/HiFICv1.1/HiFIC/utils/weights/v0.1/alex.pth'
                    
                    # import inspect
                    # import os
                    # model_path = os.path.abspath(os.path.join(inspect.getfile(self.__init__), '..', 'weights/v%s/%s.pth'%(version,net)))
                    model_path = 'logs/lpips_weights/weights/alex.pth'
